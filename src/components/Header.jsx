...
const Header = () => {
  ...
  return (
    <header
      className="w-full bg-white dark:bg-gray-800 shadow-sm px-4 lg:px-8 py-4"
      dir={i18n.language === 'ar' ? 'rtl' : 'ltr'}
    >
      <div className="container mx-auto max-w-5xl flex flex-col sm:flex-row items-center justify-between gap-4">
        <Link to="/" aria-label="Home">
          <div className="dark:bg-gray-800 rounded-xl p-2">
            <Logo
        ...
        <a
          ...
          className="flex items-center gap-2 px-4 py-2 bg-blue-500 text-white font-medium rounded-lg shadow-md hover:bg-blue-600 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200"
        ...
        <div className="flex items-center gap-4">
          <button
            className="cursor-pointer text-sm text-gray-600 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400"
