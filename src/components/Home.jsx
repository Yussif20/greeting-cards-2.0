...
const Home = () => {
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 flex flex-col items-center justify-center"
    ...
    >
      <div className="container mx-auto px-4 py-6 lg:px-8 lg:py-8 max-w-5xl text-center">
        ...
        <h1 className="text-3xl sm:text-5xl font-bold text-gray-800 dark:text-white mb-4 animate-slide-up">
          {i18n.language === 'ar' ? 'عيد أضحى مبارك' : 'Blessed Eid al-Adha'}
        </h1>
        <p className="text-lg sm:text-xl text-gray-700 dark:text-gray-300 mb-8 animate-slide-up delay-100">
          {i18n.language === 'ar'
        ...
        <Link
          to="/cards"
          className="inline-flex items-center gap-2 px-6 py-3 bg-blue-500 hover:bg-blue-600 text-white font-medium rounded-lg shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 animate-slide-up delay-300"
        >
