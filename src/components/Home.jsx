...
const Home = () => {
  ...
  return (
    <div
      className="bg-gradient-to-br from-[#e6e9f4] via-[#f4e0b5] to-[#243e87]/10 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 min-h-screen flex flex-col items-center justify-center font-sans bg-[url('/islamic-pattern-light.jpg')] dark:bg-[url('/islamic-pattern-dark.avif')] bg-repeat bg-[length:200px]"
    ...
    >
      <main className="container mx-auto px-4 py-12 lg:px-8 lg:py-16 max-w-7xl relative z-10">
        ...
        <AnimatedSection delay={400}>
          <div className="mt-12 p-6 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm rounded-2xl shadow-xl border border-[#e6e9f4] dark:border-gray-700 text-center shadow-inner">
