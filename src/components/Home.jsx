...
const Home = () => {
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 flex flex-col items-center justify-center font-sans"
        ...
        <div className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl shadow-xl p-8 text-center">
          <div className="mb-8 animate-fade-in">
            ...
            >
              <g>
                <path
                  className="fill-[#ee2e3a] dark:fill-white"
                  d="M271.79 438.93v9.46H159.96v-9.46h111.83z"
                />
                <path
                  className="fill-[#243e87] dark:fill-white"
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-800 dark:text-white mb-4 animate-slide-up">
            {isArabic ? 'عيد أضحى مبارك' : 'Blessed Eid al-Adha'}
          </h1>
          ...
          <Link
            ...
            aria-label={isArabic ? 'أنشئ بطاقتك الآن' : 'Create Your Card Now'}
          >
            {isArabic ? 'أنشئ بطاقتك الآن' : 'Create Your Card Now'}
            <ChevronRight
              size={20}
